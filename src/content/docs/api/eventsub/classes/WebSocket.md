...
| :------ | :------ | :------ |
| `connection` | [`WebSocketConnection`](/api/eventsub/classes/websocketconnection/) | The WebSocketConnection. |
...
twitchfy/packages/eventsub/src/ws/structures/WebSocket.ts:36
