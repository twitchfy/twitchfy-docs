...
import { ChatCommand } from '@twitchapi/chatbot';
...
const { ChatCommand } = require('@twitchapi/chatbot'); //using cjs
...
```ts showLineNumbers copy title="commands/hello.ts"
import { ChatCommand, SetCommand } from '@twitchapi/chatbot';
...
```ts showLineNumbers copy title="commands/hello.js"
const { ChatCommand } = require('@twitchapi/chatbot');
...
```ts showLineNumbers copy title="commands/hello.ts"
import { ChatCommand, SetCommand, type TwitchContext } from '@twitchapi/chatbot';
